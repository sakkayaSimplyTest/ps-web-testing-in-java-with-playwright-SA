...
//        page.onDialog(dialog -> dialog.accept());         //  Comment e alsam da calisiyor. Playwright has a DEFAULT DIALOGS HANDLER ancak
                                                              // bu alert dialog icin gecerli , CONfirm dialog icin degil. Yani bu satira ihtiyacimiyz olacak
   ...
   /*     page.onDialog(dialog -> {
    ...
    public void hangingTestDemo() {
        ...
        page.onDialog(dialog -> System.out.println("Dialog type found:" + dialog.type()));  //Dialog type found:prompt
